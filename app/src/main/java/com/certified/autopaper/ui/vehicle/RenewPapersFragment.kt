...
class RenewPapersFragment : Fragment() {

    private var _binding: FragmentRenewPapersBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRenewPapersBinding.inflate(layoutInflater, container, false)
        auth = Firebase.auth
        return binding.root
    }
